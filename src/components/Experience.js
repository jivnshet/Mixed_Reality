    ...
    <div className="container mx-auto">
      <div className='flex flex-col min-h-[480px] lg:space-x-20 lg:flex-row'>
        ...
        <div className='flex-1 flex flex-col items-start justify-center mt-6 lg:mt-0' data-aos="fade-left" data-aos-offset="400">
          <h2 className='text-3xl font-bold mb-6 '>New Experience in Gaming</h2>
          <p className='font-secondary mb-6 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae ea odit nisi dignissimos neque soluta et, explicabo vero consequuntur inventore?</p>
          <button className='btn'>Experience Now</button>
        </div>
      </div>
    </div>
  </section>;
