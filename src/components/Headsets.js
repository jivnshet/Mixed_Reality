    ...
    <div className="container mx-auto">
      ...
      <div className='grid gap-y-4 lg:grid-cols-2 lg:gap-9'>
        <div className='relative' data-aos="zoom-in" data-aos-offset="300" data-aos-delay="1000">
          ...
          <div className='absolute bottom-0 bg-white/20 blackdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
            <h4 className='font-semibold text-xl mb-2'>Metaverse</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae corrupti et tenetur, vitae itaque explicabo?</p>
          </div>
        </div>
        ...
        <div className='relative' data-aos="zoom-in" data-aos-offset="300" data-aos-delay="1900">
          ...
          <div className='absolute bottom-0 bg-white/20 blackdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
            <h4 className='font-semibold text-xl mb-2'>Meta</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae corrupti et tenetur, vitae itaque explicabo?</p>
          </div>
        </div>
      </div>
